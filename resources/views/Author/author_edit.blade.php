            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('authors.update', ['author' => $authors->id])}}" method='post'>
                    ...
                    <div>
                        ...
                        <textarea style="height:100px" class="input-validate bg-gray-50 border text-gray-900 text-sm rounded-lg  block w-full p-2.5"
                            type="text" id="descricao" name="descricao" placeholder="Descricao">{{$authors->descricao}}</textarea>
                             <span id="descricao-error" class="text-red-600 text-sm hidden mt-1">Digite uma descrição do autor</span>
                    </div>
