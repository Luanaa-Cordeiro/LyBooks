    ...
    <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center">
        ...
        <div class="relative p-4 w-full max-w-md max-h-full z-10 bg-white rounded-lg shadow-sm">
            ...
            <div class="p-4 md:p-5">
                <form id="create-editora-form" class="space-y-4" action="{{ route('editoras.store') }}" method="post">
                    @csrf
                    <div>
                        <label for="nome" class="block mb-2 text-sm font-medium text-gray-900">
                            Nome Editora <span class="text-red-600">*</span>
                        </label>
                        <input
                            name="nome"
                            id="nome"
                            class="input-validate bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="nome" />
                        <span id="nome-error" class="text-red-600 text-sm hidden mt-1">Digite o nome da editora</span>
                    </div>

                    <button type="submit"
                        class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                        style="background-color:#035353;">
                        Criar
                    </button>
                </form>
            </div>
        ...
        <div class="tabela p-4 border-2 border-gray-200 border-dashed rounded-lg mt-25">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    const form = document.getElementById('create-editora-form');
                    ...
                    nomeInput.addEventListener('input', () => {
                        if (nomeInput.value.trim() === '') {
                            nomeInput.classList.remove('border-gray-300', 'border-green-500');
