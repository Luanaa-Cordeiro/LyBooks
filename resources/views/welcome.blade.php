...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="items-center lg:justify-center min-h-screen flex-col">
        <header class="w-full text-sm mb-6 not-has-[nav]:hidden">
            @if (Route::has('login'))
                <nav class="flex nav_welcome items-center">
                    <h1><a href="#inicio">Lybooks</a></h1>
                    <div class='itens_nav'>
                    <ul>
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a style="color:white;"
                                href="{{ route('register') }}"
                                class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[white] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal">
                                Registrar
                            </a>
                        @endif
                    @endauth
...
<div style="color:white" class="book  flex-shrink-0">
...
<img class="" src="{{ asset('assets/images/editoras_welcome.png') }}" alt="teste" />
...
<div class="title_autores">
  ...
  <div style="margin:0 20px 0 0">
            ...
            <span style="font-weight:700; back">Nascimento</span><br>
            <span style="color:gray; font-weight:600">21 jun. 1839</span>
        </div>
        <div>
            <span style="font-weight:700">Morte</span><br>
            <span style="color:gray; font-weight:600">28 set. 1908</span>
        </div>
    </div>
...
<div style="height:220px" class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">
                <span style="color:#b36a11; font-size:35px">Machado de Assis</span>
            </h5>
        </a>
...
<footer style="background-color:#013C3C; color:white;" class="bg-white">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul style=" color:white;" class="text-gray-500 font-medium">
                      ...
                      <li>
                          <a target="_blank" href="https://trello.com/invite/b/67cef2a6f0dcd7351adc9b3b/ATTI175f3682b1b97f3d9b40468e6efd542281F44CB9/lybooks" class="hover:underline">Trello</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" class="hover:underline">LyBooks™</a>.
          </span>
