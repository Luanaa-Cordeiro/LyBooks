      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="{{route('languages.index')}}" class="links_nav flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
            <!--<img src="{{ asset('assets/images/home.png') }}" alt="">-->
            <span class="active  flex-1 ms-3 whitespace-nowrap">Linguagens</span>
          </a>
        </li>
        <li>
  ...
  <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full z-10 bg-white rounded-lg shadow-sm">
      ...
      <div class="p-4 md:p-5">
        <form id="create-language-form" class="space-y-4" action="{{ route('languages.store')}}" method="post">
          @csrf
          <div>

            <label for="idioma" class="block mb-2 text-sm font-medium text-gray-900">Linguagem <span style="color:red;">*</span></label>
            <input name="idioma" id="idioma" class="input-validate bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Linguagem" value='{{old("idioma")}}' />
