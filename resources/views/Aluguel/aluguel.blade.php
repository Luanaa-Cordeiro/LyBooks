            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{route('alugueis.index')}}" class="links_nav flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        <!--<img src="{{ asset('assets/images/home.png') }}" alt="">-->
                        <span class="active flex-1 ms-3 whitespace-nowrap">Alugados</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center">
        ...
        <div class="relative p-4 w-full max-w-md max-h-full z-10 bg-white rounded-lg shadow-sm">
            ...
            <div class="p-4 md:p-5">
                <form id="create-aluguel-form" class="space-y-4" action="{{ route('alugueis.store')}}" method="post">
                    @csrf

                    <div>
                        <label for="nome" class="block mb-2 text-sm font-medium text-gray-900">Nome do Livro <span style="color:red;">*</span></label>
                        <input name="nome" id="nome" class="input-validate bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Nome do livro" value="{{ old('nome') }}" />
                    ...
                    <div>
                        ...
                        <input name="locatario" id="locatario" class="input-validate bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Nome do locatário" value="{{ old('locatario') }}" />
                    ...
                    <div>
                        ...
                        <input type="date" name="data_aluguel" id="data_aluguel" class="input-validate bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            value="{{ old('data_aluguel') }}" />
                    ...
                    <div>
                        ...
                        <input type="date" name="data_devolucao" id="data_devolucao" class="input-validate bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    ...
                    <button style="background-color:#035353;" type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        Criar
                    </button>
                </form>
            </div>
        ...
        <div class="tabela  p-4 border-2 border-gray-200 border-dashed rounded-lg mt-25">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    const form = document.getElementById('create-aluguel-form');
